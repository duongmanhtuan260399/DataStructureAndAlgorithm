class DSALinkedList:
    ...
    def displayReverse(self):
        """
        Display the contents of the linked list from tail to head.
        """
        if self.isEmpty():
            print("List is empty")
            return
    ...
    def insertBefore(self, valueToFind, newValue):
        """
        Insert a new node with newValue before the first occurrence of valueToFind.
        ...
        # Create new node
        new_node = self._DSAListNode(newValue)
        ...
        if current == self._head:
            ...
            # Inserting before a middle or last node
    ...
    def peek(self, valueToFind):
        """
        Return the value of the first occurrence of valueToFind without removing it.
        If valueToFind is not found, raises ValueError.
        """
        if self.isEmpty():
            raise ValueError(f"Value {valueToFind} not found in empty list")
